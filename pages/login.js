    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
            <div className='hidden sm:block'>
                ...
                <Image src={'/login.jpeg'} alt={''} 
                width={300} 
                height={400}
                className='w-full h-full object-cover'  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"/>
            ...
            <div className='bg-gray-100 flex flex-col justify-center'>
                <form onSubmit={handleSubmit(onSubmit)} className='max-w-[400px] w-full mx-auto bg-white p-4'>
                    ...
                    <button className='border w-full my-5 py-2 bg-emerald-50 text-emerald-500 disabled:text-white hover:bg-emerald-500 hover:text-white transition-colors duration-500 rounded-md w-100 disabled:bg-slate-300 disabled:cursor-not-allowed'>Sign In</button>
                    {/*  py-3 px-5  */}
